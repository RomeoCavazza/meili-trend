...
export const generateMockPosts = (hashtag: string = 'fashion', count: number = 50): InstagramPost[] => {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      media_url: `https://images.unsplash.com/photo-${1500000000000 + i * 1000000}?w=800&q=80`,
      thumbnail_url: `https://images.unsplash.com/photo-${1500000000000 + i * 1000000}?w=400&q=80`,
